            ...
            Seq.mapi (fun j candidatesCell2 -> 
                    Seq.mapi (fun k candidatesCell3 -> 
                            Seq.mapi (fun k candidatesCell4 -> 
                                let candidatesCellAll = set [candidatesCell1; candidatesCell2; candidatesCell3; candidatesCell4 ]
                                findNaked candidatesCellAll candidateCells house) (Seq.skip (i + j + k + 3) hht)) (Seq.skip (i + j + 2) hht)) 
